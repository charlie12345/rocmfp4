...
MAX_FAST_US="${MAX_FAST_US:-56.0}"
MAX_DUAL_US="${MAX_DUAL_US:-70.0}"
MAX_FAST_N2_US="${MAX_FAST_N2_US:-76.0}"
MAX_DUAL_N2_US="${MAX_DUAL_N2_US:-88.0}"
MAX_FAST_N4_US="${MAX_FAST_N4_US:-112.0}"
MAX_DUAL_N4_US="${MAX_DUAL_N4_US:-130.0}"
MAX_FAST_N8_US="${MAX_FAST_N8_US:-190.0}"
MAX_DUAL_N8_US="${MAX_DUAL_N8_US:-220.0}"
